...
void TagAndProbe::CreateHistos(string TypeSel, string datasetname){
  ...
  if(TypeSel == "muons"){
     ...
     h_pt   = new TH1F( (datasetname+TypeSel+"_looseID_pt").c_str(),  "", 10, ptRange); 
     hlist_Mu_LooseID.push_back(h_pt);
     h_pt_supEta15   = new TH1F( (datasetname+TypeSel+"_looseID_pt_supEta15").c_str(),  "", 10, ptRange); 
     hlist_Mu_LooseID.push_back(h_pt_supEta15);
     h_pt_infEta15   = new TH1F( (datasetname+TypeSel+"_looseID_pt_infEta15").c_str(),  "", 10, ptRange); 
     ...
     h_pt   = new TH1F( (datasetname+TypeSel+"_looseIso_pt").c_str(),  "", 10, ptRange); 
     hlist_Mu_LooseIso.push_back(h_pt);       
     h_pt_supEta15   = new TH1F( (datasetname+TypeSel+"_looseIso_pt_supEta15").c_str(),  "", 10, ptRange); 
     hlist_Mu_LooseIso.push_back(h_pt_supEta15);   
     h_pt_infEta15   = new TH1F( (datasetname+TypeSel+"_looseIso_pt_infEta15").c_str(),  "", 10, ptRange); 
     ...
     //*******************
     //for tight selection
     h_pt   = new TH1F( (datasetname+TypeSel+"_Tight_pt").c_str(),  "", 10, ptRange); 
     hlist_Mu_Tight.push_back(h_pt);
     h_pt_supEta15   = new TH1F( (datasetname+TypeSel+"_Tight_pt_supEta15").c_str(),  "", 10, ptRange); 
     hlist_Mu_Tight.push_back(h_pt_supEta15);
     h_pt_infEta15   = new TH1F( (datasetname+TypeSel+"_Tight_pt_infEta15").c_str(),  "", 10, ptRange); 
