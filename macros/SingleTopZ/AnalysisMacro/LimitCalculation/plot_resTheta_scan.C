...
// @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
 ...
 ifstream in_obs;
 in_obs.open("ResultsZut/cls_limits_observed.txt");
 ...
 ifstream in_exp;
 in_exp.open("ResultsZut/cls_limits_expected.txt");
...
// @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
 ...
 if (Type!="param") {
  ...
  histo->GetXaxis()->SetTitle("Nevents");
    ...
    //if(isZut) histo->GetXaxis()->SetTitle("#kappa_{zut}/#Lambda");
    //else histo->GetXaxis()->SetTitle("#kappa_{zct}/#Lambda");
