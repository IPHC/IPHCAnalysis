...
//  char* file = argv[1];//"/opt/sbg/data/data1/cms/jlagram/data/Data_2011/DoubleMu_2011_part1.root"
  ...
  //TString file = "/opt/sbg/cms/ui6_data1/ccollard/CMS_Prod_428p7/NTuples/SingleElectron/"+ff;
  TString file = "/opt/sbg/cms/ui6_data1/ccollard/CMS_Prod_428p7/NTuples/SingleMuon/"+ff;
  ...
  for (unsigned int ievt=0;ievt< nentries; ievt++)
  {
    ...
    JEC_L2L3Residuals.ApplyCorrections(event);
